...
public:
    ...
    void ConsultJaque(bool& jW, bool& jB, bool& jMW, bool& jMB) {
        jW = jaqW;
        jB = jaqB;
        jMW = jaqMW;
        jMB = jaqMB;
